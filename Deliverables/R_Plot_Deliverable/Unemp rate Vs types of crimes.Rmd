...
ggplot(d +
  geom_histogram( aes(d$NE_Unemployment_Rate,..d$Crime_Aggravated_Assaul..t) ) +
  geom_density(aes(d$NE_Unemployment_Rate,..d$Crime_Aggravated_Assault..))+
  geom_rug( aes(d$NE_Unemployment_Rate) ))
